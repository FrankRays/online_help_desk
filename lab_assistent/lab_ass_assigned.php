...
<div id="button">
        <ul>
            ...
            <li><a href="lab_ass_assigned.php">Assigned Duties</a></li>
 ...
 <!-- Dashboard icons -->
            <div class="not_list">
                <ul style="list-style-type:none;" align="center" >
                    <?php 
                    $query = mysql_query("SELECT * FROM assign WHERE assigny_username='$user' AND ass_designation='Lab Assistent' LIMIT 1");
