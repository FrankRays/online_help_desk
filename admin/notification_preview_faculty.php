            ...
            <div class="not_list">
                ...
                $query = mysql_query("SELECT * FROM request WHERE user_to='$user' AND position ='$position'"); 
                   ...
                   <?php  $query_check = mysql_query("SELECT * FROM request WHERE request_id='$request_id'");
                            ...
                            ?>
                    <li>
                    <b><?php echo "FACULTY ".$applicant ." from ".$dept." Department has requested for  
                    ...
                    <?php echo "<a href='faculty_notification_result.php?name=assign_and_accept&id=$request_id'><button type='button'>Assign and Accept</button></a>"; ?>
                    <?php echo "<a href='student_notification_result.php?name=decline&id=$request_id'><button type='button'>Decline</button></a>"; 
                        }?>

                    <?php echo "<a href='faculty_notification_result.php?name=see_complete&id=$request_id'><button type='button'>See complete Request</button></a>"; ?>
