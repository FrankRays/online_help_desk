...
<div id="main">
 ...
 <!-- Dashboard icons -->
            <div class="grid_7">
            	<a href="notification_preview_student.php" class="dashboard-module">
                    <img src="../images/admin_icon.jpg" width="75" height="75" alt="edit" />
                    <span>Notification related to Student Request</span>
                </a>
                <a href="notification_preview_faculty.php" class="dashboard-module">
                    <img src="../images/faculties.png"  width="75" height="75" alt="edit" />
                    <span>Notification related to Faculty Request</span>
                </a>  
                <a href="notification_preview_hod.php" class="dashboard-module">
                    <img src="../images/faculties.png"  width="75" height="75" alt="edit" />
                    <span>Notification related to HOD</span>
                </a>
                <a href="notification_preview_others.php" class="dashboard-module">
                    <img src="../images/faculties.png"  width="75" height="75" alt="edit" />
                    <span>Notification related to others</span>
                </a>
