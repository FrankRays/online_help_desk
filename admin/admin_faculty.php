...
//include_once('../PHPMailer/language/phpmailer.lang-am.php');
...
$user=$_POST['username'];
$pas=$_POST['password'];
$sql1=mysql_query("SELECT * FROM faculties WHERE username='$user'");
 $result=mysql_fetch_array($sql1);
if($result>0){
$message="<font color=blue>sorry the username entered already exists</font>";
 }else{
$sql=mysql_query("INSERT INTO faculties(first_name,last_name,faculty_department,address,phone,email,username,password,date)
...
if($sql>0) {
	...
	$to_name = $fname;
	$to = $email;
	$subject = "Username and Password @ OHD  MAIT ";
	$message = "USername:  ". $user ."<br/> password: ".$pas;
	$from_name = "ADMIT @ OHD_MAIT";
	$from = "mohit.chawla16@gmail.com";
	$mail = new PHPMailer();
	// $mail->IsSMTP();
 ...
 //    $mail->Username = "mohit.chawla16@gmail.com"; // GMAIL username
 //    $mail->Password = "read123@#%84mohit"; // GMAIL password
	...
	$mess1= "OHD@ MAIT Account Info TYPE-FACULTy";
...
<hr/>	
    <div class="tabbed_area">  
       ...
       $result = mysql_query("SELECT * FROM faculties")or die(mysql_error());
        ...
        while($row = mysql_fetch_array( $result )) {
				...
				?>
				<td><a href="update_faculty.php?username=<?php echo $row['username']?>"><img src="../images/update-icon.png" width="35" height="35" border="0" /></a></td>
				<td><a href="delete_faculty.php?faculty_id=<?php echo $row['faculty_id']?>"><img src="../images/delete-icon.jpg" width="35" height="35" border="0" /></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
?> 
        ...
        <div id="content_2" class="content">  
			  ...
			  echo $message1;
			  ?>
		<form name="form1" onsubmit="return validateForm(this);" action="admin_faculty.php" method="post" id="feedback" >
