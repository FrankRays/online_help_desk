...
<div id="content">
<div id="header">
<div id="notify"> Hi, <?php echo $user; ?><a href="notification.php"><img src="../images/newsfeeds.png" /> </a></div>
...
<div id="main">
 ...
 <!-- Dashboard icons -->
            <div class="grid_7">
                ...
                <a href="admin_lab_assistent.php" class="dashboard-module">
                	<img src="../images/Text-Edit-icon.png"  width="75" height="75" alt="edit" />
