...
<ul>
			...
			<li><a href="faculty_assigned.php"target="_top">Assigned Duties </a></li>
...
<!-- Dashboard icons -->
            <div class="grid_7">
            	<a href="faculty.php" class="dashboard-module">
                	<img src="../images/cashier_icon.jpg" width="100" height="100" alt="edit" />
                	<span>Dashboard</span>
                </a>
			     <a href="faculty_assigned.php" target="_top" class="dashboard-module">
                	<img src="../images/payment.png" width="100" height="100" alt="edit" />
                	<span>Assigned Duties</span>
                </a>
				<a href="faculty_request.php" target="_top" class="dashboard-module">
                	<img src="../images/payment.png" width="100" height="100" alt="edit" />
